...
import { selCartCntState } from './../recoil/selector/selCartCntState';

export const Contents = () => {
  const [myCart, setMyCart] = useRecoilState(cartCountState);
  const cartData = useRecoilValue(selCartCntState);
  ...
  console.log('sel', cartData);
  console.log('atom', myCart);
    ...
    <div className="mt-5">
      <Card style={{ width: '18rem' }}>
        <Card.Body>
          ...
          <Card.Text>현재 담긴 상품 개수는 {myCart.cartCnt}개입니다</Card.Text>
