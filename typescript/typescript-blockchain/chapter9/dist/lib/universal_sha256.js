...
function sha256_browser(data) {
    return __awaiter(this, void 0, void 0, function () {
        var msgUnit8Array, hashByteArray, hashArray, hashHex;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    msgUnit8Array = new TextEncoder().encode(data);
                    return [4 /*yield*/, crypto.subtle.digest('SHA-256', msgUnit8Array)];
                case 1:
                    hashByteArray = _a.sent();
                    hashArray = Array.from(new Uint8Array(hashByteArray));
                    hashHex = hashArray
